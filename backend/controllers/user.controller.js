...
export const getProfile = asyncHandler(async(req, res)=>{
    ...
    const user = await User.findById(req.userId).populate("auth", "email username").populate("previousSplits", "-__v -createdAt -updatedAt");
    if (!user) {
    ...
    const data = {
        ...
        previousSplits: user.previousSplits,
